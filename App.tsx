...
const EN: Record<string, string> = {
  ...
  '漸層': 'Gradient', '選擇色點': 'Pick a stop', '漸層色': 'Gradient color', '極簡色調': 'Minimal', '花園藤椅': 'Garden', '午夜霓虹': 'Midnight', '日光閃爍': 'Sunlight',
...
function createStyles(C: ThemeColors) {
  ...
  content: { flex: 1, paddingHorizontal: 20 }, homeListTop: { paddingTop: 12, paddingHorizontal: 8 }, titleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, title: { fontSize: 21, fontWeight: '800', color: C.ink, marginBottom: 12 }, list: { paddingBottom: 110, gap: 12 },
